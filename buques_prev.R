...
write_csv(prev_llegadas_BCN, paste0("data/previsiones_port/prev_llegadas_BCN_", today(), ".csv"))
...
write_csv(prev_salidas_BCN, paste0("data/previsiones_port/prev_salidas_BCN_", today(), ".csv"))
